...
class BilinearInterpolation {
    ...
    public static void main(String[] args) throws IOException {
        File file = new File("img/frame10x10.bmp");
        BufferedImage image = ImageIO.read(file);
        BufferedImage image2 = scale(image, (float) Double.parseDouble(args[0].trim()), (float) Double.parseDouble(args[1].trim()));
        //File lenna2 = new File("img/xD.jpg");
